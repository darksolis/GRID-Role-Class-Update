...
function GridFrame:RegisterFrame(frame)
	...
	local decorations = Grid:HasModule("GridFrameDecorations") and Grid:GetModule("GridFrameDecorations")
	if decorations then
		decorations:AttachFrame(self.registeredFrames[frame:GetName()])
	end
