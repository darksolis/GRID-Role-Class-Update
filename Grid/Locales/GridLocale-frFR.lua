...
--{{{ GridLayout
    ...
    ["By Owner Primary stat"] = "Selon l'attribut principal du maître",
...
--{{{ GridStatusHealth
    ...
    ["Use primary stat color"] = "Utiliser les couleurs des attributs primaires",
    ["Use custom color"] = "Utiliser couleurs personnalisée",
