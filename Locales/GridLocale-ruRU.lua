...
--{{{ GridLayout
    ...
    ["By Owner Primary stat"] = "по основному атрибуту владельца",
...
--{{{ GridStatusHealth
    ...
    ["Use primary stat color"] = "Использовать цвет основного атрибута",
    ["Use custom color"] = "Использовать собственный цвет",
